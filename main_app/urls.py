...
urlpatterns = [
    ...
    path('purchases/', views.TrackerList.as_view(), name="purchases_done"),
    ...
    path('dogs/<int:pk>/update', views.BudgetUpdate.as_view(), name="budget_update"),
    path('dogs/<int:pk>/delete',views.BudgetDelete.as_view(), name="budget_delete"),
]